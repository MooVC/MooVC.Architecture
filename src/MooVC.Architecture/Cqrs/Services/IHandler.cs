...
/// </summary>
/// <typeparam name="T">The type of message to be handled, where T must be a subclass of <see cref="Message"/>.</typeparam>
    ...
    where T : Message
{
    ...
    /// </summary>
    /// <param name="message">The message of type <typeparamref name="T"/> to be handled.</param>
    ...
    /// </param>
    /// <returns>A task that represents the asynchronous operation, containing no result upon completion.</returns>
