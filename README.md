...
- Added a new Aborted event to Architecture.Ddd.Services.IRepository<TAggregate> (**Breaking Change**).
...
- Renamed Architecture.Ddd.Services.IRepository<TAggregate>.AggregateSaved to Saved (**Breaking Change**).
- Renamed Architecture.Ddd.Services.IRepository<TAggregate>.AggregateSaving to Saving (**Breaking Change**).
