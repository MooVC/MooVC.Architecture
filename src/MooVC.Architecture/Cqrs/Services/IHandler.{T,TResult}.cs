...
/// </summary>
/// <typeparam name="T">
/// The type of the input message to be handled, where T must be a subclass of <see cref="Message"/>.
/// </typeparam>
/// <typeparam name="TResult">
/// The type of the result message produced by the handler, where TResult must be a subclass of <see cref="Message"/>.
/// </typeparam>
    ...
    where TResult : Message
{
    ...
    /// </summary>
    /// <param name="message">
    /// The input message of type <typeparamref name="T"/> to be handled.
    /// </param>
    ...
    /// </returns>
    Task<TResult> Execute(T message, CancellationToken cancellationToken);
}